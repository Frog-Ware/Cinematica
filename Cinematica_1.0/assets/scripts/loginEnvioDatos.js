...
function enviarDatosRegistro() {
    ...
    .then(data => {
        if (!data.error) {
            ...
            alert("Este es tu Token sin el no podras cambiar la contraseña: " + data.token);
        } else {
            switch (data.error) {
                case 1:
    ...
    // .catch(error => console.error('Error:', error));ewqe
}
        ...
        if (!data.error) {
            ...
            switch (data.error) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    console.log('La dirección de correo ingresada se encuentra registrada como administrador');
                    break;
                default:
                    console.log('Error desconocido');
            }
