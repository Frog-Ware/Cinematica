...
// Este script devuelve una lista de las fotos del slider disponibles.
...
enum err: int
{
    ...
    function getMsg()
    {
        return match ($this) {
            ...
            self::NO_SUCCESS => "No hay imagenes de slider disponibles."
        };
    }
}
...
function main()
{
    // Devuelve los nombres de las imagenes si no hay errores y un código de error si no hay resultados.
    $datos = traerSlider();
    $response = ($datos != null) ?
