        ...
        productos.forEach((producto, index) => {
            ...
            botonMas.addEventListener('click', function () {
                ...
                if (!productoExistente) {
                    ...
                    listaImgImg.src = 'assets/img/productos/' + producto.imagen;
                    listaImgImg.alt = producto.nombreArticulo;
                    ...
                    listaContenidoNombre.textContent = producto.nombreArticulo;
                    ...
                    precioAumentado.textContent = `$${producto.precio * parseInt(cont.value)}`; // Actualizar el precio total
